...
<head>
    ...
    <meta name="author" content="Javier Marin (jmarin@aden.org)">
...
<?php if(getUserImage()):?>
                                ...
                                <img src="<?=getUserImage()?>" class="user-image" alt="User Image">
<?php endif?>
                                <!-- hidden-xs hides the username on small devices so only the image appears. -->
                                <span class="hidden-xs"><?=$this->yo['nombre']?></span>
                            </a>
                            <ul class="dropdown-menu">
...
<?php endif?>
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="<?=BASEURL.'login/logout'?>" class="btn btn-default btn-flat">Sign out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
